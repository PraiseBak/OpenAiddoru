...
public class IdolVideoInfoService {
    ...
    //그냥 300개 다 조지는 코드 디버깅용임
    public void updateRecentVideoDebug(){
        //0에서 100
        Pageable pageable = PageUtility.getPageable(0, 100);
        List<Idol> idolList = idolService.getVTuberListOrderByRanking(0,"");
        List<String> channelIdList = new ArrayList<>();
        for(Idol idol : idolList.subList(0,100)){
